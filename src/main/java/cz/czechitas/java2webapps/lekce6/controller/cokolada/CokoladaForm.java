...
public class CokoladaForm {
    ...
    public CokoladaForm(@NotBlank String druh, @NotBlank String velikost, @NotBlank String jmeno, @Email @NotBlank String email, @AssertTrue boolean obchodniPodminky) {
        this.druh = druh;
